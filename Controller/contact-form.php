...
$smtpUsername = "aszeidan83@gmail.com";
$smtpPassword = "hiam.com.123";
$emailFrom = $smtpUsername;
$emailFromName = "PI Mail Support";
$emailToDaniel = "daniel@park-innovation.com";
$emailToNameDaniel = "Daniel Awde";
...
try {
    ...
    $emailTextHtml = "<h2>You have a new message from your park innovation website contact form</h2><hr>";
    $emailTextHtml .= "<table>";
    ...
    $mail->addAddress($emailToDaniel, $emailToNameDaniel);

    $mail->Subject = 'Park Innovation Website Contact Form Message';
