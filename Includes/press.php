...
<div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-lg-offset-2 py-5">
<h3 class="GothamBold title mb-4 mt-4">Contact us for any press related info </h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="form_message" name="message" class="form-control" placeholder="Text" rows="4" required="required" data-error="Please, leave us a message."></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <input type="submit" class="btn btn-success btn-send  margin-auto" value="Send message">
